...
extension ToDoQueryFilter on QueryBuilder<ToDo, ToDo, QFilterCondition> {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteEqualTo(
    String? value, {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'note',
        value: '',
  ...
  QueryBuilder<ToDo, ToDo, QAfterFilterCondition> noteIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'note',
        value: '',
...
extension ToDoQuerySortBy on QueryBuilder<ToDo, ToDo, QSortBy> {
  ...
  QueryBuilder<ToDo, ToDo, QAfterSortBy> sortByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ToDoQuerySortThenBy on QueryBuilder<ToDo, ToDo, QSortThenBy> {
  ...
  QueryBuilder<ToDo, ToDo, QAfterSortBy> thenByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.desc);
    });
  }
